...
export class UIHandlers {
    ...
    setupEventListeners() {
        ...
        if (stimStartStopButton) {
            stimStartStopButton.addEventListener("click", (e) => this.handleStartStop(e));
        }
        ...
        if (stimPauseResumeButton) {
            stimPauseResumeButton.addEventListener("click", (e) => this.handlePauseResume(e));
        }
    ...
    async handleStartStop(e) {
        if (!this.stimDisplay.running) { //If the session is not running, start running 
            ...
            const stimStartStopButton = document.getElementById("stimStartStopButton");
            if (stimStartStopButton) { //Disable and change the text of the start button. 
    ...
    async handlePauseResume(e) {
        if (this.stimDisplay.paused) { //Resume the session. 
            try {
