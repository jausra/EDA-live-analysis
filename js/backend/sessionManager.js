...
export class SessionManager {
  ...
  initStimDisplayCB() {
    ...
    this.stimDisplay.onStimDisplay(
      ({ stim, round, color, startTime, stopTime }) => {
        this.roundManager.handleGameStimulus(
          ...
          (round_, stim_, type_, startTime_, stopTime_) =>
            this.dataProcessor.updateSessionCSVData(
              round_,
              stim_,
              type_,
              startTime_,
  ...
  async msiStartSession() {
    ...
    if (this.stimAnalyzer && this.stimAnalyzer.resetScores) {
    ...
    await new Promise((resolve) => {
      ...
      displayText.innerHTML = `
                <div id="countdownContainer" style="display: flex; flex-direction: column; align-items: center;">
                    <div id="countdownLabel" style="font-size: 0.5em; margin-bottom: 0.3em;">Game start in</div>
